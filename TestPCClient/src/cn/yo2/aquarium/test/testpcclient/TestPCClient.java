...
public class TestPCClient {
    ...
    public static void main(String[] args) throws InterruptedException {
        try {
            System.out.println("adb shell am broadcast -a NotifyServiceStop");
            Runtime.getRuntime().exec("adb shell am broadcast -a NotifyServiceStop");
            Thread.sleep(3000);

            System.out.println("adb shell am broadcast -a NotifyServiceStart");
            Runtime.getRuntime().exec("adb shell am broadcast -a NotifyServiceStart");
            Thread.sleep(3000);

            System.out.println("adb forward tcp:12580 tcp:10086");
