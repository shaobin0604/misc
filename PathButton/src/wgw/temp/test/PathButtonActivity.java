		...
		buttonDelete.setOnClickListener(new OnClickListener() 
		{
			...
			public void onClick(View v) 
			{
				...
				if(isClick == false)
				{
					...
					buttonThought.startAnimation(animTranslate(90.0f, -60.0f, 170, height - 140, buttonThought, 160));
					buttonSleep.startAnimation(animTranslate(170.0f, -30.0f, 180, height - 100, buttonSleep, 180));
