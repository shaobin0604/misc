 ...
 * p.addLast("aggregator", <b>new {@link ConditionalHttpChunkAggregator}(1048576)</b>);
 * ...
 ...
 */
public class ConditionalHttpChunkAggregator extends SimpleChannelUpstreamHandler implements LifeCycleAwareChannelHandler {
    ...
    private boolean isFileUpload;   // whether current message is part of file upload
    ...
    public void messageReceived(ChannelHandlerContext ctx, MessageEvent e)
        ...
        if (msg instanceof HttpMessage) {
            ...
            if (msg instanceof HttpRequest) {
                ...
                isFileUpload = uri.contains("import");
            }
        ...
        } else if (msg instanceof HttpChunk && !isFileUpload) {
            // Sanity check
